...
public class testcase_8 {
    ...
    public void tc_8(){
        ...
        //10.click on remove checkbox
        driver.findElement(By.xpath("//input[@name='removefromcart']")).click();
        driver.findElement(By.xpath("//input[@name='updatecart']")).click();
        String cart_empty_msg=driver.findElement(By.xpath("//div[@class='order-summary-content']")).getText();
        org.testng.Assert.assertTrue(cart_empty_msg.contains("empty"));
    }
}
